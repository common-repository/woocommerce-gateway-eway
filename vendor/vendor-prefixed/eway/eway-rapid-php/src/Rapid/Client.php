...
namespace Automattic\WooCommerce\Eway\Vendors\Eway\Rapid;

use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Contract\Client as ClientContract;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Contract\Http\ResponseInterface;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Contract\HttpService as HttpServiceContract;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\ApiMethod;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\PaymentMethod;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\TransactionType;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\LogLevel;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Exception\MassAssignmentException;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Exception\MethodNotImplementedException;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Exception\RequestException;
...
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\AbstractResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\Creation3dsEnrolmentResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\CreateCustomerResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\CreateTransactionResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\QueryAccessCodeResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\QueryCustomerResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\QueryTransactionResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\RefundResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\SettlementSearchResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Response\Verification3dsEnrolmentResponse;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Transaction;
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Service\Http;
...
class Client implements ClientContract
{
    ...
    {
        $apiMethod = EnumValidator::validate('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\ApiMethod', 'ApiMethod', $apiMethod);

        /** @var Transaction $transaction */
        $transaction = ClassValidator::getInstance('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Transaction', $transaction);
    ...
    private function doCreateCustomer($apiMethod, $customer)
    {
        ...
        $customer = ClassValidator::getInstance('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Customer', $customer);
    ...
    {
        /** @var Refund $refund */
        $refund = ClassValidator::getInstance('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Refund', $refund);
    ...
    {
        $search = ClassValidator::getInstance('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\SettlementSearch', $query);
     ...
     * token transaction
     *
     * @param Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Customer $customer
     * @return Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Transaction
     */
    private function customerToTransaction($customer)
    {
        ...
        /** @var Transaction $transaction */
        return ClassValidator::getInstance('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Model\Transaction', $transaction);
    }
