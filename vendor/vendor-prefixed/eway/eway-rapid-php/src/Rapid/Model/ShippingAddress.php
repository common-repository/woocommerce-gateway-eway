...
use Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\ShippingMethod;
...
class ShippingAddress extends AbstractModel
{
    ...
    public function setShippingMethodAttribute($shippingMethod)
    {
        if (null === $shippingMethod) {
            ...
            $this->validateEnum('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\ShippingMethod', 'ShippingMethod', $shippingMethod);
        }
