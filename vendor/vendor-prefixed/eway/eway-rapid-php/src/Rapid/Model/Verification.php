...
class Verification extends AbstractModel
{
    ...
    {
        $this->validateEnum('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\VerifyStatus', 'CVN', $cvn);
    ...
    {
        $this->validateEnum('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\VerifyStatus', 'Address', $address);
    ...
    {
        $this->validateEnum('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\VerifyStatus', 'Email', $email);
    ...
    {
        $this->validateEnum('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\VerifyStatus', 'Mobile', $mobile);
    ...
    {
        $this->validateEnum('Automattic\WooCommerce\Eway\Vendors\Eway\Rapid\Enum\VerifyStatus', 'Phone', $phone);
